...
```text
Evidence Constructor -> Domain Extractor -> Generator -> Evaluator -> Refiner -> Final selection
```
...
- Why does the Domain Agent directly target a weakness of the old paper?
